...
import successAnimation from "../assets/successcheck.json";
...
function Login() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            setShowSuccess(true); // show animation, don't navigate yet
        } catch (err) {
    ...
    // Called by the Player once the animation has finished playing
        ...
        <div className="page">
            <style>{`
                ...
                * { box-sizing: border-box; }
                ...
                .card.fade-out { opacity: 0.15; pointer-events: none; }
            ...
            <div className={`card${showSuccess ? " fade-out" : ""}`}>
                <div className="brand">
